                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="action-btn">
                                        <a href="/admin/type/update?id=<?php echo $value['id']; ?>" style="padding: 3px 10px;" class="btn btn-primary" type="button">Edit</a>
                                    ...
                                    <form action="<?= base_url('/admin/type/delete'); ?>" method="post">
