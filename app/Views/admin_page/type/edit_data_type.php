        ...
        <?php //foreach ($data as $type) { ?>
            ...
            <div class="row">
                <div class="col-md-12 overflow-hidden">
                    ...
                    <hr>
                    <form action="<?= base_url('/admin/type/update'); ?>" method="post">
                        <input type="hidden" id="id" name="id" value="<?php echo $data['id']; ?>">
                        <div class="mb-3">
                            <label for="namaProduk" class="form-label">Nama Type</label>
                            <input type="text" class="form-control" id="type" name="type" value="<?= $data['name']; ?>">
                        </div>
